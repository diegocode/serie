...
# -*- coding: UTF-8 -*-
#
# generated by wxGlade 0.6.8 on Fri Feb 12 02:25:51 2016
#
...
class mainUI(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        #self.btnPortOpen = wx.Button(self.panel_6, wx.ID_ANY, _("cerrar"))
        #self.lblPortOpen = wx.StaticText(self.panel_6, wx.ID_ANY, _("abierto..."))
    ...
    def __set_properties(self):
        # begin wxGlade: mainUI.__set_properties
        ...
        #self.lblPortOpen.SetMinSize((42, 15))
        #self.lblPortOpen.SetFont(wx.Font(9, wx.DEFAULT, wx.NORMAL, wx.NORMAL, 0, "Noto Sans [monotype]"))
        # end wxGlade

    def __do_layout(self):
        # begin wxGlade: mainUI.__do_layout
        ...
        #sizer_14_copy_4.Add(self.btnPortOpen, 0, wx.ALIGN_CENTER_VERTICAL, 0)
        #sizer_14_copy_4.Add(self.lblPortOpen, 0, wx.LEFT | wx.ALIGN_CENTER_VERTICAL, 8)
    ...
    def hbtnDTR(self, event):  # wxGlade: mainUI.<event_handler>
